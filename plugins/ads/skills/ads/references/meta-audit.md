...
| M26 | Creative volume per ad set | High | Standard: ≥5 per ad set (ideal 5-8); ASC: ≥50 creatives (ideal 50-150, max 150/campaign) | Standard: 3-4 creatives; ASC: 20-49 creatives | Standard: <3 per ad set; ASC: <20 creatives |
| M27 | Video aspect ratios | High | 9:16 vertical video present for Reels/Stories | Only 1:1 or 4:5 video | No video assets |
| M28 | Creative fatigue detection | Critical | No creatives with CTR drop >20% over 14 days while active; no creatives active >90 days | CTR drop 10-20% OR creatives active 60-90 days | CTR drop >20% + frequency >3 (fatigue confirmed) OR any creative active >90 days regardless of CTR |
...
| M-CR5 | Creative age limit | High | No creatives active >90 days | Creatives active 60-90 days | Any creative active >90 days (replace regardless of performance) |
...
| M15 | Advantage+ Sales campaign | Medium | ASC active for e-commerce with catalog | ASC tested but paused | Not tested despite eligible catalog | **N/A if non-e-commerce or no product catalog** |
...
| M20 | Custom Audience freshness | High | Website Custom Audiences refreshed within 180 days | 180-365 days old | >365 days old or not created | **N/A if no Custom Audiences in use** |
| M21 | Lookalike source quality | Medium | Lookalike source ≥1,000 users from high-value events | 500-1,000 users | <500 users or low-value source | **N/A if no Lookalike audiences in use** |
...
| M24 | First-party data utilization | High | Customer list uploaded for Custom Audience + Lookalike | List uploaded but not refreshed | No first-party data uploaded | **N/A if business has <500 customer records** |

---

## Context Notes

- **Andromeda Algorithm & Creative Volume (2024-2026)**: Meta's Andromeda deep-learning delivery system clusters conceptually similar creatives together. Loading 20+ nearly-identical variations is counterproductive — diversity of **angle, format, persona, and message** matters more than raw quantity. Standard ad sets need 5-8 conceptually different creatives; ASC campaigns benefit from 50-150 creatives because the algorithm has more personas to match across broader audiences. Top brands refresh every 10.4 days on average. See `creative-volume.md` for full per-platform production benchmarks.
