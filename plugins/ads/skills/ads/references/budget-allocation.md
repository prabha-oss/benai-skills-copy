...
### Budget Minimums by Business Type

| Business Type | Min Monthly (single platform) | Min Monthly (multi-platform) | Notes |
|--------------|------------------------------|------------------------------|-------|
| E-commerce DTC | $3,000 | $5,000 | Need ≥50 conv/week for Meta learning |
| SaaS B2B | $5,000 | $8,000 | Long sales cycles, expensive keywords |
| Local Service | $1,500 | $2,500 | Lower CPCs but need volume |
| B2B Enterprise | $10,000 | $15,000 | High CPCs on LinkedIn ($5-35) |
| Info Products | $2,000 | $3,500 | Funnel testing needs budget flexibility |
| Mobile App | $5,000 | $8,000 | CPI varies widely; need scale for data |
| Real Estate | $2,500 | $4,000 | Geo-targeted, moderate CPCs |
| Healthcare | $4,000 | $6,000 | Compliance overhead, competitive CPCs |
| Finance/Fintech | $8,000 | $12,000 | High CPCs, compliance costs |
| Agency (Own) | $1,500 | $2,500 | Lower CPCs, B2B targeting |

### Budget Sufficiency Severity

| Actual vs Minimum | Severity | Finding |
|-------------------|----------|---------|
| <50% of minimum | CRITICAL | Budget severely insufficient — campaigns cannot learn. Recommend consolidating to fewer platforms or pausing until budget increases |
| 50-80% of minimum | HIGH | Budget below recommended minimum — expect Learning Limited status and inconsistent performance |
| 80-100% of minimum | WARNING | Budget marginally sufficient — monitor learning phase closely, consider consolidation |
| ≥100% of minimum | PASS | Budget meets minimum threshold for platform/business type |

### Multi-Platform Budget Rule

When running 2+ platforms: total budget should be ≥150% of the highest single-platform minimum. Running 3+ platforms below minimum per-platform wastes spend across too many underfunded campaigns.
