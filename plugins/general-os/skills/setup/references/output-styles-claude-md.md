...
| SOP | `sop.md` | Standard operating procedures (business mode) |
| Report | `report.md` | Business reports for stakeholders (business mode) |
...
5. **Stack with memory**: Combine the style with `Context/me.md` for personalization
...
The user's unique voice and patterns should be captured in `Context/me.md` and applied ON TOP of whichever style is active.
