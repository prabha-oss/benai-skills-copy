...
## Learning Phase Exit Strategies by Budget Level

Not all advertisers can meet ideal learning phase thresholds. Adapt evaluation based on budget reality:

### High Budget (≥100% of platform minimum)
- Standard learning phase rules apply
- Full severity scoring for learning-related checks
- Target: exit learning phase within 7-14 days

### Medium Budget (50-99% of platform minimum)
- **Evaluation**: WARNING (not FAIL) for learning phase checks
- **Strategy**: Consolidate ad groups/sets to concentrate conversions
- Switch to higher-funnel conversion events (e.g., AddToCart vs Purchase)
- Use Portfolio bid strategies (Google) to pool data across campaigns
- Consider broader targeting to increase conversion volume

### Low Budget (<50% of platform minimum)
- **Evaluation**: WARNING with budget context note (not FAIL)
- Do NOT penalize for failing learning phase — the budget makes it impossible
- **Alternative strategies**:
  1. **Consolidate to single platform** rather than spreading thin
  2. **Use micro-conversions** (page view, scroll, add-to-cart) as optimization events
  3. **Manual CPC bidding** (Google) or Lowest Cost uncapped (Meta) — don't fight automation with insufficient data
  4. **Maximize Clicks** (Google) to build pixel data before switching to conversion optimization
  5. **Extend learning window** — evaluate over 14-21 days instead of 7
- Recommend platform consolidation in findings

### Platform-Specific Guidance

| Platform | Minimum for Learning | Low-Budget Alternative |
|----------|---------------------|----------------------|
| Google | 15+ conv/30d | Maximize Clicks → Manual CPC with CPC cap |
| Meta | 50 conv/week/ad set | Lowest Cost, broader audience, consolidate ad sets |
| TikTok | 50 conv/week/ad group | Lowest Cost, fewer ad groups, higher-funnel events |
| LinkedIn | 15 conv/month | Maximum Delivery, broader targeting |
