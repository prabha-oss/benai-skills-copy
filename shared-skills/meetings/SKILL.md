---
name: meetings
description: Process meeting transcripts and sync from Fireflies.ai — extract decisions, action items, create summaries, and file in the right folder. Use when user pastes a transcript, mentions meetings, wants to sync Fireflies, or runs /meetings.
---
...
2. If it does NOT exist:
   - Tell the user: "This vault hasn't been set up yet. Run `/setup` to bootstrap your personal assistant OS."
   - Stop here
